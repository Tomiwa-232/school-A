          ...
          <!-- <div class="col-lg-3 col-md-6 mt-4 mt-lg-0" > -->
            ...
            <div class="login">
                ...
                <form action="#">
                    ...
                    <div class="error-txtt"><button type="button" hidden class="btn btn-danger liveAlertBtn" id="liveAlertBtn" ></button> </div>
...
if (alertTrigger) {
  alertTrigger.addEventListener('click', () => {
    alert('We are sorry, your login details are not correct!', 'danger')
  })
}
